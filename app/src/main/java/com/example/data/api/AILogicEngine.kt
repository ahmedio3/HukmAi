        ...
        try {
            ...
            val finalPrompt = """
                ...
                **تعليمات مهمة جداً - التزم بها بدقة:**
                - ابدأ إجابتك فوراً بعنوان "**خلاصة القول:**" ثم اكتب ملخصاً بسيطاً وسهل الفهم للحكم الفقهي في ٢-٣ جمل. هذا إلزامي في كل رد. لا تبدأ بأي عبارات افتتاحية (الحمد لله، سبحان الله، أما بعد، إلخ).
                - بعد الخلاصة، فصّل في الإجابة مع الاستشهاد بالأدلة والنصوص الحرفية.
                - عند تخريج حديث: اكتب التخريج كاملاً كما في المصدر مع الرقم: (رواه البخاري ٢٣٤) (رواه مسلم ١). إذا كان للحديث مصدران، اكتب: (رواه البخاري ٢٣٤ ومسلم ١).
                - عند النقل عن عالم: اكتب التخريج كاملاً مع الجزء والصفحة: [المجموع للنووي، جـ ٢ صـ ٤٥].
                - التخريجات والهوامش توضع بين معقوفين [...] دائماً ولا تجعلها بخط غامق أبداً.
